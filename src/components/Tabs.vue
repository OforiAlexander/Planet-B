...
<div class="mb-4 border-b border-gray-700 flex w-full justify-center">
...
<div id="default-styled-tab-content">
    <div class=" p-4 rounded-lg" id="styled-profile" role="tabpanel" aria-labelledby="profile-tab">
